...
- Variables: `NODE_VERSION=24.13.0`, `NODE_ENV=production`, `SERVE_FRONTEND=false`, `DATABASE_URL` y `MOBILE_ORIGINS`.
...
Este despliegue sirve solamente la API; el panel local conserva su configuración habitual. Las rutas administrativas mantienen su autenticación. Render gratuito se suspende tras 15 minutos sin tráfico y la primera petición posterior puede tardar en responder.
